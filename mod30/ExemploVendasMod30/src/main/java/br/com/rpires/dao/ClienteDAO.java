...
public class ClienteDAO extends GenericDAO<Cliente, Long> implements IClienteDAO {
    ...
    public void atualiarDados(Cliente entity, Cliente entityCadastrado) {
        ...
        entityCadastrado.setNovoCampo(entity.getNovoCampo()); // Novo campo adicionado
    }
    ...
    protected String getQueryInsercao() {
        ...
        sb.append("(ID, NOME, CPF, TEL, ENDERECO, NUMERO, CIDADE, ESTADO, NOVO_CAMPO)"); // Novo campo adicionado
    ...
    protected void setParametrosQueryInsercao(PreparedStatement stmInsert, Cliente entity) throws SQLException {
        ...
        stmInsert.setString(8, entity.getNovoCampo()); // Novo campo adicionado
    }
    ...
    protected String getQueryAtualizacao() {
        ...
        sb.append("CIDADE = ?,");
        sb.append("ESTADO = ?,");
        sb.append("NOVO_CAMPO = ?"); // Novo campo adicionado
        sb.append(" WHERE CPF = ?");
        return sb.toString();
    }
    ...
    protected void setParametrosQueryAtualizacao(PreparedStatement stmUpdate, Cliente entity) throws SQLException {
        ...
        stmUpdate.setString(7, entity.getNovoCampo()); // Novo campo adicionado
